...
class BaseRandomPizza:
    """Class "BaseRandomPizza" contains information about daily ingredients of pizza;
...
class PizzaOfTheDay(BaseRandomPizza):
    """Class "PizzaOfTheDay" inherits class "BaseRandomPizza"; it defines the date of making order. """
